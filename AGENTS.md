...
- `README.md`：项目目标、覆盖范围和设计原则。
- `doc/architecture.md`：权威架构、接口方向、模态原理、里程碑及合规边界。
...
- 行为、配置、CLI、公共 API、默认值或支持格式变化时，同步更新 `README.md` 和 `doc/`。
...
- `doc/AGENTS.md`：引用格式、算法来源与文档验证规则。
