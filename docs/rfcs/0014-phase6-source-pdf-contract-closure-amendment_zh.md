...
`(page, run, start_text_offset)` 改变；因此 cross-page move 通过不同的 `before_run.page` 与
`after_run.page` 表示，没有需要协调的冗余 top-level page。Extracted-text fact 有 `page_count`、`run_count`、
