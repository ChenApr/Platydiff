...
- Closure amendment：[RFC 0014](0014-phase6-source-pdf-contract-closure-amendment_zh.md)
  接受 P6C0A-1-P6C0A-2，用于 P6-C0 problem-registry 与 closed-union closure；
  不授权实现
...
从更新后的 `main` 显式派发。[RFC 0014](0014-phase6-source-pdf-contract-closure-amendment_zh.md)
接受 P6C0A-1 与 P6C0A-2 closure amendment，用于 P6-C0 problem-registry 与 closed-union
closure；该接受不启动代码。
...
problem code 与 spec validation 均冻结，包括 accepted RFC 0014 P6C0A-1 与 P6C0A-2
closure rule；不实现 source/PDF comparator、backend 或 CLI 行为。P6-C0 必须在 P6-S1、P6-P1a
或任何后续 Phase 6 comparator/backend gate 开始前合并。
