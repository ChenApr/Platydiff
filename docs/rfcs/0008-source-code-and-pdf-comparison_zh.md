...
- Proposed closure amendment：[RFC 0014](0014-phase6-source-pdf-contract-closure-amendment_zh.md)
  草拟 P6C0A-1-P6C0A-2，用于 P6-C0 problem-registry 与 closed-union closure；
  这些 decision 尚未接受
...
从更新后的 `main` 显式派发。[RFC 0014](0014-phase6-source-pdf-contract-closure-amendment_zh.md) 包含 proposed
P6C0A-1 与 P6C0A-2 closure amendment，供未来 P6-C0 review 使用；它们尚未接受，也不启动代码。
...
problem code 与 spec validation 均冻结；proposed RFC 0014 P6C0A-1 与 P6C0A-2 必须在
