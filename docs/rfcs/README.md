...
| [0008](0008-source-code-and-pdf-comparison.md) | Proposed | Define explicit source-code and PDF comparison contracts, including schema-v5 allocation, behind independently authorized Phase 6 gates |
| [0009](0009-audio-and-video-comparison.md) | Proposed | Define explicit audio and video comparison contracts, including schema-v6 allocation and P7-S0 review constraints, behind independently authorized Phase 7 gates |
