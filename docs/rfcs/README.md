...
| [0010](0010-schema-predecessor-and-phase6-contract-amendment.md) | Proposed | Resolve the schema-v3 predecessor contradiction and Phase 6 P6-C0 contract gaps before downstream schema implementation |
