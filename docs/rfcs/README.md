...
| [0005](0005-third-party-plugin-discovery-sdk-and-compatibility.md) | Proposed | Define explicit third-party discovery, a versioned SDK, deterministic capability execution, and compatibility evidence |
