...
| [0006](0006-structured-data-comparison.md) | Proposed | Define explicit JSON/YAML, table, and dense-array semantics behind schema-v3 and separately authorized delivery gates |
