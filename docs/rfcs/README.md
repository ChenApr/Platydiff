...
| [0010](0010-schema-predecessor-and-phase6-contract-amendment.md) | Accepted | Select Option A/P4-C1 for the schema-v3 predecessor correction and accept P6-C0 contract-gap decisions before downstream implementation |
