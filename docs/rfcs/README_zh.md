...
| [0008](0008-source-code-and-pdf-comparison_zh.md) | Proposed | 在独立授权的 Phase 6 门禁后定义显式 source-code/PDF 比较契约与 schema-v5 分配 |
| [0009](0009-audio-and-video-comparison_zh.md) | Proposed | 在独立授权的 Phase 7 门禁后定义显式 audio/video 比较契约、schema-v6 分配与 P7-S0 review 约束 |
