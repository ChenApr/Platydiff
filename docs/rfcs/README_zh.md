...
| [0007](0007-image-comparison_zh.md) | Accepted | 接受 schema v4 的显式静态 PNG decoded-sample 切片，并延后 perceptual、artifact、plugin 与 detection 工作 |
| [0008](0008-source-code-and-pdf-comparison_zh.md) | Accepted | 接受独立授权 Phase 6 门禁后的显式 source-code 与 PDF 比较契约，以及 schema-v5 allocation |
