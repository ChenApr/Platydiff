...
Phase 1 is implemented: the Python package, schema-v1 contracts, explicit text
pipeline, linear-space Myers algorithm, CLI, and terminal/JSON renderers are
available. Every other modality and renderer listed below remains planned.
